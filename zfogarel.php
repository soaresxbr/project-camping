        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5 align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <div class="fs-5 mb-5">
                        <span class="text-decoration-">Diária: R$ 10</span>
                    </div>
                    <p class="lead">Esse fogareiro é uma ótima opção para você preparar as refeições no seu acampamento. Ele é leve, compacto, possui regulador para controle da chama e ignição eletrônica, então você não precisa usar isqueiro ou fósforo para acender.</p>
                </div>
                <h7>Observação: o valor da diária é apenas para o fogareiro. Vendemos o cartucho tekgas com 230g  por R$ 25.</h7>
            </div>
        </div>
    </section> 
